...
$('<style>' +
	...
	'#inpCampaignLogNameFilter {width: auto;padding: 4px 5px;margin-left: 5px; margin-right: 3px;}' +
...
setTimeout(function(){
	...
	$('#inpCampaignLogNameFilter').next().css({display: 'inline-block', position: 'relative', top: '2px', left: '0px'}).show();
