...
//mbox helper functions - END
	...
	//Dialog placeholder
	 $("html > body").append('<div id="ttHighlDialOverlay">&nbsp;</div><div id="ttHighlDialContentWrap"><div id="ttHighlDialTitle"><span class="tt-title">T&amp;T Tools <span title="v1.2 changes: Adding Anonymizer option when URL has bank.barclays.co.uk; The T&T Tools Summary & Highlights DO NOT show by default, you can use the [Show Summary] or [Highlight All Mboxes] buttons to do so - this allows quicker clean page overview; Added functionality to switch between default and T&T offer for any non-default mbox location; Added option to Show/Remove highlights; Added option to edit offers\'s HTML in place">(v1.2)</span></span><button class="tt-title-close-btn" role="button" title="close"><span class="tt-closethick"></span><span class="tt-title-close-text">close</span></button></div><div id="ttHighlDialContent">Summary of T&amp;T Campaigns, Experiences, Locations and Offers running on the page</div></div>');
